...
// GetAccountFlowParams is parameters of getAccountFlow operation.
type GetAccountFlowParams struct {
	// Account ID.
	AccountID string
...
func unpackGetAccountFlowParams(packed middleware.Parameters) (params GetAccountFlowParams) {
	{
		key := middleware.ParameterKey{
			Name: "account_id",
			In:   "path",
...
func decodeGetAccountFlowParams(args [1]string, argsEscaped bool, r *http.Request) (params GetAccountFlowParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Decode path: account_id.
	if err := func() error {
		param := args[0]
