...
// GetInvoiceHistoryParams is parameters of getInvoiceHistory operation.
type GetInvoiceHistoryParams struct {
	// Account ID.
	AccountID string
...
func unpackGetInvoiceHistoryParams(packed middleware.Parameters) (params GetInvoiceHistoryParams) {
	{
		key := middleware.ParameterKey{
			Name: "account_id",
			In:   "path",
...
func decodeGetInvoiceHistoryParams(args [1]string, argsEscaped bool, r *http.Request) (params GetInvoiceHistoryParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Decode path: account_id.
	if err := func() error {
		param := args[0]
