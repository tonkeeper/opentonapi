...
// GetExtraCurrenciesParams is parameters of getExtraCurrencies operation.
type GetExtraCurrenciesParams struct {
	Limit  OptInt
	Offset OptInt
}

func unpackGetExtraCurrenciesParams(packed middleware.Parameters) (params GetExtraCurrenciesParams) {
	{
		key := middleware.ParameterKey{
			Name: "limit",
			In:   "query",
...
func decodeGetExtraCurrenciesParams(args [0]string, argsEscaped bool, r *http.Request) (params GetExtraCurrenciesParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Set default value for query: limit.
	{
		val := int(1000)
