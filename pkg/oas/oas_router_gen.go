				...
				case 'c': // Prefix: "ccounts/"
					...
					case '/': // Prefix: "/"
						...
						case 'd': // Prefix: "d"
							...
							switch elem[0] {
							case 'e': // Prefix: "efi/assets"

								if l := len("efi/assets"); len(elem) >= l && elem[0:l] == "efi/assets" {
									elem = elem[l:]
								} else {
									break
								}
						...
						case 'f': // Prefix: "flow"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleGetAccountFlowRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
				...
				case 'e': // Prefix: "ewards/"
					...
					case 's': // Prefix: "stats"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetRewardsStatsRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
									allowedMethods: "GET",
									allowedHeaders: nil,
					...
					case '/': // Prefix: "/"
							...
							case 'e': // Prefix: "efi/assets"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.operationGroup = ""
										r.pathPattern = "/v2/accounts/{account_id}/defi/assets"
										r.args = args
										r.count = 1
										return r, true
									default:
						...
						case 'f': // Prefix: "flow"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = GetAccountFlowOperation
									r.summary = ""
									r.operationID = "getAccountFlow"
									r.operationGroup = ""
									r.pathPattern = "/v2/accounts/{account_id}/flow"
									r.args = args
									r.count = 1
									return r, true
								default:
				...
				case 'e': // Prefix: "ewards/"
					...
					case 's': // Prefix: "stats"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = GetRewardsStatsOperation
								r.summary = "Get historical APY and stake statistics"
								r.operationID = "getRewardsStats"
								r.operationGroup = ""
								r.pathPattern = "/v2/rewards/stats"
								r.args = args
								r.count = 0
								return r, true
							default:
